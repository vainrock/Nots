...
@Component({
  ...
  template: `
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div *ngFor="let note of notes" class="bg-gray-900 border border-violet-500/30 p-6 rounded-xl relative group transition-all duration-300 hover:border-pink-500/60 shadow-[0_0_15px_rgba(139,92,246,0.1)] hover:shadow-[0_0_25px_rgba(236,72,153,0.25)] hover:-translate-y-1 overflow-hidden">
        ...
        <button (click)="deleteNote(note.id)" class="absolute top-4 right-4 text-gray-600 opacity-0 group-hover:opacity-100 transition-all hover:text-pink-500 hover:shadow-[0_0_10px_rgba(236,72,153,0.5)]">
